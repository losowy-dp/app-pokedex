package com.example.apppokedex.ui.theme
...
val AtColor = Color(0xFFF08030)
val DefColor = Color(0xFFF8D030)
val SpecAtColor = Color(0xFF6890F0)
val SpecDefColor = Color(0xFF78C850)
val SpeedColor = Color(0xFFF85888)

//Color to Type Pokemon
